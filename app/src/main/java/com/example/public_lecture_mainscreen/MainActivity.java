...
public class MainActivity extends AppCompatActivity {
    ...
    public void Update_DB(View view) {
        Intent intent = new Intent(this, com.example.public_lecture_mainscreen.ProgressDialog.class);
    ...
    public void LctreNm_search(View view) {
        EditText edit;
        TextView pageNumView, lctName1, lctName2, lctName3, lctName4, lctName5, lctName6, lctName7, lctName8, lctName9, lctName10, subName1, subName2, subName3, subName4, subName5, subName6, subName7, subName8, subName9, subName10, lctName0;
        ...
        CheckBox cb1 = (CheckBox)findViewById(R.id.area2);
...
//        queryString, args.toArray()
    ...
    public void search_next(View view) {
        EditText edit;
        TextView pageNumView, lctName1, lctName2, lctName3, lctName4, lctName5, lctName6, lctName7, lctName8, lctName9, lctName10, subName1, subName2, subName3, subName4, subName5, subName6, subName7, subName8, subName9, subName10;
        edit = (EditText) findViewById(R.id.editTextTextPersonName);
        lctName1 = (TextView) findViewById(R.id.lcturNm1);
        subName1 = (TextView) findViewById(R.id.instNm1);
        lctName2 = (TextView) findViewById(R.id.lcturNm2);
...
//        String str = edit.getText().toString();
//        String searchKeyword = "%" + str + "%";
//        List<Course> searchResult = mCourseDao.test_select(searchKeyword);
...
//        List<Course> searchResult = mCourseDao.test_select(searchKeyword);
    ...
    public void lctClick1(View view){
        if(nowPage!=0) {
            touchIndex=0;
    ...
    public void lctClick2(View view){
        if(nowPage!=0) {
            touchIndex=1;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick3(View view){
        if(nowPage!=0) {
            touchIndex=2;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick4(View view){
        if(nowPage!=0) {
            touchIndex=3;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick5(View view){
        if(nowPage!=0) {
            touchIndex=4;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick6(View view){
        if(nowPage!=0) {
            touchIndex=5;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick7(View view){
        if(nowPage!=0) {
            touchIndex=6;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick8(View view){
        if(nowPage!=0) {
            touchIndex=7;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick9(View view){
        if(nowPage!=0) {
            touchIndex=8;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void lctClick10(View view){
        if(nowPage!=0) {
            touchIndex=9;
            Intent intent = new Intent(this, PopupInformationActivity.class);
            startActivityForResult(intent, 1);
    ...
    public void favorites_text_click(View view){
        ...
        if(view.getId() == R.id.top_title1){
            favoritesIndex = 0;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title2){
            favoritesIndex = 1;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title3){
            favoritesIndex = 2;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title4){
            favoritesIndex = 3;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title5){
            favoritesIndex = 4;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title6){
            favoritesIndex = 5;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title7){
            favoritesIndex = 6;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title8){
            favoritesIndex = 7;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title9){
            favoritesIndex = 8;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
        else if(view.getId() == R.id.top_title10){
            favoritesIndex = 9;
            Intent intent = new Intent(this, PopupFavoritesInformActivity.class);
            startActivityForResult(intent, 1);
        }
    ...
    public void favoriteCalCheck(View v){ //favorite - Calendar
        ...
        if(v.getId() == R.id.fav1){
            ...
            if(checkBox_favorite1.isChecked()){
                ((MainActivity) MainActivity.context).mFavoritesDao.set_T(favoritesList.get(favoriteindex).getId());
            }else {
                ((MainActivity) MainActivity.context).mFavoritesDao.set_F(favoritesList.get(favoriteindex).getId());
            }
        }
